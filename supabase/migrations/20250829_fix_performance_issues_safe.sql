-- Fix Performance Issues Identified in Supabase Performance Report (SAFE VERSION)
-- Date: 2025-08-29
...
DROP POLICY IF EXISTS "advisor_group_members_select" ON public.advisor_group_members;
DROP POLICY IF EXISTS "advisor_group_members_insert" ON public.advisor_group_members;
DROP POLICY IF EXISTS "advisor_group_members_update" ON public.advisor_group_members;
DROP POLICY IF EXISTS "advisor_group_members_delete" ON public.advisor_group_members;
DROP POLICY IF EXISTS "advisor_group_members_modify" ON public.advisor_group_members;
...
DROP POLICY IF EXISTS "advisor_groups_select" ON public.advisor_groups;
DROP POLICY IF EXISTS "advisor_groups_insert" ON public.advisor_groups;
DROP POLICY IF EXISTS "advisor_groups_update" ON public.advisor_groups;
DROP POLICY IF EXISTS "advisor_groups_delete" ON public.advisor_groups;
DROP POLICY IF EXISTS "advisor_groups_modify" ON public.advisor_groups;
...
DROP POLICY IF EXISTS "leaderboards_select" ON public.leaderboards;
...
DROP POLICY IF EXISTS "leaderboards_modify" ON public.leaderboards;
...
DROP POLICY IF EXISTS "learning_logs_backup_admin" ON public.learning_logs_backup;

-- Create new consolidated admin-only policy
...
DROP POLICY IF EXISTS "parent_child_relationships_select" ON public.parent_child_relationships;
DROP POLICY IF EXISTS "parent_child_relationships_insert" ON public.parent_child_relationships;
DROP POLICY IF EXISTS "parent_child_relationships_update" ON public.parent_child_relationships;
DROP POLICY IF EXISTS "parent_child_relationships_delete" ON public.parent_child_relationships;
DROP POLICY IF EXISTS "parent_child_relationships_modify" ON public.parent_child_relationships;
...
DROP POLICY IF EXISTS "quest_collaborations_select" ON public.quest_collaborations;
DROP POLICY IF EXISTS "quest_collaborations_insert" ON public.quest_collaborations;
DROP POLICY IF EXISTS "quest_collaborations_update" ON public.quest_collaborations;
...
DROP POLICY IF EXISTS "quest_reviews_select" ON public.quest_reviews;
DROP POLICY IF EXISTS "quest_reviews_insert" ON public.quest_reviews;
DROP POLICY IF EXISTS "quest_reviews_update" ON public.quest_reviews;
DROP POLICY IF EXISTS "quest_reviews_delete" ON public.quest_reviews;
