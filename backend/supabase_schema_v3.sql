-- Optio Platform V3 Database Schema
-- Updated to align with current quest system and pillar structure
...
CREATE TABLE user_quests (
    ...
    is_active BOOLEAN DEFAULT TRUE,
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
    UNIQUE(user_id, quest_id, is_active) -- Allow only one active enrollment per user per quest
);
