...
def reset_test_user_data(preserve_enrollments=False):
    ...
    try:
        ...
        if quests.data and len(quests.data) >= 3:
            ...
            print("   E2E tests need at least 3 quests to work properly")
