...
# ── Login information ────────────────────────────────────────────────────────
# "Email login info" lives in its own module (this file sits at the 1400-line
# route cap). Registered here rather than in routes/__init__.py so the
# blueprint still has exactly one owner.
