...
/**
 * Everything the SIS Classes page reads and writes (QF-03).
 *
 ...
 *
 * Split into two queries rather than one, because they are refetched at
 * different moments. The catalog is what the page renders; the conflicts are an
 * advisory cross-check re-run after any save that can touch a teacher or a
 * room, and re-running seven requests to answer "is this class double-booked
 * now" would be worse than the hand-rolled version it replaces.
 *
...
/** The advisory double-booking rows, for teachers and for rooms. */
