/**
 * OpenEd Academy landing (/opened-academy).
 *
...
function ParentView() {
  ...
  return (
    <PageShell
      ...
      subtitle="Track credits and learning toward an OpenEd Academy diploma."
    >
      <div className="rounded-2xl border border-neutral-200 bg-white p-5 shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-neutral-900">How it works</span>
        </div>
            ...
            return (
              <div key={s.id} className="rounded-2xl border border-neutral-200 bg-white p-5">
                ...
                <p className={`text-sm ${pathwayName ? 'text-neutral-600' : 'text-amber-700'}`}>
                  {pathwayName || 'No pathway chosen yet'}
                </p>
                {pathwayName ? (
                  <div className="flex gap-2 mt-3">
                    <button
                      type="button"
                      onClick={() => navigate(`/opened-academy/student/${s.id}/credits`, { state: { studentName: name } })}
                    ...
                    <button
                      type="button"
                      onClick={() => navigate(`/opened-academy/student/${s.id}/pathway`, { state: { studentName: name } })}
...
function StudentView({ user }) {
  return (
    <PageShell
      title="My OpenEd Academy diploma"
      subtitle="Your progress toward a 24-credit OpenEd Academy diploma."
    >
