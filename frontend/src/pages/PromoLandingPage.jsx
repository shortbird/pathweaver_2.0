...
const PromoLandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <div className="bg-gradient-to-br bg-gradient-primary text-white relative overflow-hidden">
      ...
      {/* Final CTA */}
      <div className="py-16 bg-gradient-to-br bg-gradient-primary text-white">
