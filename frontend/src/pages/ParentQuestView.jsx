    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="p-8">
          ...
          <div className="mt-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className="text-sm font-bold text-purple-600" style={{ fontFamily: 'Poppins, sans-serif' }}>
                {progress.percentage}%
              </span>
            </div>
      ...
      <div className="bg-purple-50 border-2 border-purple-200 rounded-lg p-4 mb-6">
        <div className="flex items-start gap-3">
          <BookOpenIcon className="w-6 h-6 text-purple-600 flex-shrink-0 mt-0.5" />
          <div>
                ...
                <div className="flex-1">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-semibold text-purple-600" style={{ fontFamily: 'Poppins, sans-serif' }}>
                        {task.xp_value} XP
                      </span>
                    </div>
                  </div>
