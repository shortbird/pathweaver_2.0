        ...
        <div className="text-center">
          ...
          <div className="flex justify-center gap-4">
            <button
              ...
              className="bg-gradient-primary-reverse text-white px-8 py-3 rounded-[30px] font-semibold shadow-[0_4px_20px_rgba(239,89,123,0.15)] hover:shadow-[0_6px_25px_rgba(239,89,123,0.25)] hover:-translate-y-0.5 transition-all duration-300"
            >
                          ...
                          <div className="flex items-start justify-between">
                            ...
                            <div className="flex gap-2">
                              <button
                                ...
                                className="bg-gradient-primary-reverse text-white px-4 py-2 rounded-full text-sm font-semibold hover:shadow-lg transition-all duration-300"
                              >
                                Accept
                              </button>
                              <button
            ...
            <div className="p-6">
                        ...
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex flex-col sm:flex-row gap-2 ml-3">
                            <button
                              ...
                              className="bg-gradient-primary-reverse text-white px-4 py-2 rounded-lg text-sm font-semibold hover:shadow-lg transition-all duration-300"
                            >
                              Accept
                            </button>
                            <button
              ...
              {teamInvitations.length === 0 && sentTeamInvitations.length === 0 && activeCollaborations.length === 0 && (
                <div className="text-center py-12">
                  ...
                  <button
                    onClick={() => navigate('/quests')}
                    className="bg-gradient-primary-reverse text-white px-6 py-3 rounded-lg font-medium hover:shadow-lg transition-all duration-300"
                  >
                    Browse Quests
                  </button>
                </div>
