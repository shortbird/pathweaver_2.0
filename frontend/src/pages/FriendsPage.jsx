                          ...
                          <div className="flex items-start justify-between">
                            ...
                            <div className="flex gap-2">
                              <button
                                ...
                                className="bg-gradient-primary text-white px-4 py-2 rounded-full text-sm font-semibold hover:shadow-lg transition-all duration-300"
                              >
                                Accept
                              </button>
                              <button
                        ...
                        <div className="flex items-start justify-between">
                          ...
                          <div className="flex flex-col sm:flex-row gap-2 ml-3">
                            <button
                              ...
                              className="bg-gradient-primary text-white px-4 py-2 rounded-lg text-sm font-semibold hover:shadow-lg transition-all duration-300"
                            >
                              Accept
                            </button>
                            <button
