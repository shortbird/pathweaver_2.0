  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <Link
          to="/my-classes"
          className="block p-4 rounded-xl bg-white border border-gray-200 hover:border-optio-purple transition group"
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-optio-purple to-optio-pink flex items-center justify-center">
              ...
              <div>
                ...
                <div className="text-sm text-gray-500">Create and manage classes you run for your friends</div>
              </div>
            </div>
            <svg className="w-5 h-5 text-gray-400 group-hover:text-optio-purple transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
