        ...
        <div className="text-center">
          ...
          <div className="relative w-32 h-32 mx-auto mb-8">
            {[0, 1, 2, 3, 4].map((i) => (
              ...
              >
                <div className="w-4 h-4 rounded-full bg-gradient-primary-reverse" />
              </motion.div>
            ))}
          </div>
      ...
      <div className="fixed inset-0 z-[9999] bg-gradient-to-br from-gray-900 to-black
        ...
        <div className="text-center max-w-md px-6">
          ...
          <div className="flex gap-4 justify-center">
            <button
              onClick={handleRetry}
              className="px-8 py-3 bg-gradient-primary-reverse
      ...
      <div className="fixed inset-0 z-[9999] bg-gradient-to-br from-gray-900 to-black
        ...
        <div className="text-center max-w-2xl px-6">
          ...
          <button
            ...
            className="px-10 py-4 bg-gradient-primary-reverse
