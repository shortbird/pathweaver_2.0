...
/**
 * Family Directory — opt-in contact list for the school. Families that don't
 * opt in are invisible here (staff can always reach everyone through the
 * school). The family's own opt-in toggle lives at the top.
 *
 * Readable by everyone in the school as of 2026-08-06, not only by other
 * guardians — students and staff too. That widened who can see an opted-in
 * family's phone number and address, so the toggle's copy says so outright
 * rather than leaving families to assume the old family-to-family audience.
 * Guardians who had already opted in keep their choice; only the description
 * of it changed.
 */
