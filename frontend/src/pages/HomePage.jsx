            ...
            <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8 hover:shadow-lg transition-shadow border-2 border-primary relative">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">Access to a team of Optio educators</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-500 line-through">Daily check-ins with an Optio licensed educator</span>
                </li>
              </ul>
              <Link 
                to="/register" 
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8 hover:shadow-lg transition-shadow">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start">
                  ...
                  <span className="text-gray-700">Daily check-ins with an Optio licensed educator</span>
                </li>
                <li className="flex items-start">
                  <svg className="w-5 h-5 text-green-500 mr-2 flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
