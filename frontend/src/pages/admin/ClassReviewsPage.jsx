...
// Holistic admin review of student class submissions. Per-task credit review
// (already done) happens elsewhere; this surface handles the milestone
// submission that asks Optio to issue a transcript line for the class.
    ...
    <div className="grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-6">
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
        <div className="flex items-center justify-between px-4 py-3 border-b border-gray-200">
          <h2 className="font-semibold text-gray-900">Class Reviews</h2>
          <select
            value={status}
      ...
      <div className="bg-white border border-gray-200 rounded-xl">
        {!selectedId ? (
          ...
          <div className="p-6">
            ...
            <div className="mb-6">
              <h4 className="text-sm font-semibold text-gray-900 mb-2">Approved tasks ({detail.tasks.length})</h4>
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                {detail.tasks.length === 0 ? (
                  <div className="p-4 text-sm text-gray-500">No approved tasks yet</div>
                ) : detail.tasks.map((t) => (
                  <div key={t.completion_id} className="px-4 py-3 border-b border-gray-100 last:border-b-0">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <div className="text-xs text-gray-500 whitespace-nowrap">
                        {t.subject_xp_attributed} XP • {t.xp_value} total
                      </div>
                    </div>
                    {t.description && (
...
export default ClassReviewsPage
