      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center">
          ...
          <button
            ...
            className="px-4 py-2 bg-gradient-to-r bg-gradient-primary text-white rounded-lg hover:shadow-lg transition-all mr-4"
          >
            Retry
          </button>
          <button
    ...
    return (
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <button 
            onClick={() => navigate('/quests')}
            className="bg-gradient-to-r bg-gradient-primary-reverse text-white px-6 py-3 rounded-[30px] hover:shadow-lg transition-all"
          >
            Back to Quests
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative min-h-[500px] w-full overflow-hidden pb-8">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6">
          ...
          <button
            onClick={() => navigate(-1)}
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r bg-gradient-primary text-white rounded-full hover:shadow-lg transition-all font-semibold mb-6"
          >
          ...
          {(quest.user_enrollment || isQuestCompleted) && (
            <div className="max-w-2xl">
              ...
              <div className="w-full bg-gray-200 rounded-full h-6 mb-4 overflow-hidden relative">
                <div
                  className="h-full bg-gradient-to-r bg-gradient-primary-reverse rounded-full transition-all duration-1000 ease-out"
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                {quest.user_enrollment && !isQuestCompleted && (
                  <button
                    ...
                    className="px-6 py-2 bg-gradient-to-r bg-gradient-primary-reverse text-white rounded-full hover:shadow-lg transition-all font-bold disabled:opacity-50 ml-auto"
              ...
              <>
                {canStartQuests ? (
                  ...
                  <button
                    ...
                    className="flex-1 bg-gradient-to-r bg-gradient-primary-reverse text-white py-4 px-8 rounded-[30px] hover:shadow-[0_8px_30px_rgba(239,89,123,0.3)] hover:-translate-y-1 transition-all duration-300 font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <Target className="w-5 h-5 inline mr-2" />
        ...
        <div className="mb-8">
          {quest.quest_tasks && quest.quest_tasks.length > 0 ? (
            ...
            <div className="text-center py-12 bg-white rounded-xl shadow-md">
              ...
              <button
                onClick={() => setShowPersonalizationWizard(true)}
                className="px-6 py-3 bg-gradient-to-r bg-gradient-primary-reverse text-white rounded-lg font-semibold hover:opacity-90"
              >
                Personalize Quest
              </button>
            </div>
