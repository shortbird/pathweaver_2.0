              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                {analytics.learning_pillars_covered.map((pillar, index) => (
                  <div key={index} className="text-center p-4 bg-gray-50 rounded-lg">
                    <div className="w-8 h-8 bg-gradient-primary rounded-full mx-auto mb-2"></div>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="pt-4 border-t border-gray-200">
                <button
                  ...
                  className="bg-gradient-primary text-white px-6 py-2 rounded-md hover:shadow-lg transition-shadow"
                >
                  Save Settings
                </button>
              </div>
