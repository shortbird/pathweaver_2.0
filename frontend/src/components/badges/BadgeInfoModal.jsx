      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between rounded-t-2xl">
          <div className="flex items-center gap-3">
            <div className="bg-gradient-to-r from-[#ef597b] to-[#6d469b] p-2 rounded-lg">
        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-pink-50 border-2 border-purple-200 rounded-lg p-4">
                <div className="flex items-start gap-3 mb-2">
                  <div className="bg-gradient-to-r from-[#ef597b] to-[#6d469b] text-white rounded px-2 py-1 text-sm font-bold">3</div>
                  <div className="flex-1">
          ...
          <button
            onClick={onClose}
            className="w-full px-6 py-3 bg-gradient-to-r from-[#ef597b] to-[#6d469b] text-white rounded-xl font-semibold hover:opacity-90 transition-opacity"
          >
            Got It!
          </button>
        </div>
