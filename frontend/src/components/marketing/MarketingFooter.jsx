...
const SOCIAL_LINKS = [
  ...
  {
    name: 'TikTok',
    href: 'https://www.tiktok.com/@optioeducation',
            ...
            <div className="flex items-center gap-4 mt-5">
              {SOCIAL_LINKS.map(({ name, href, path }) => (
                <a
                  ...
                  aria-label={`Optio on ${name}`}
                  onClick={() => captureEvent('marketing_footer_link_click', { link: name, section: 'social', path: href })}
