    ...
    return (
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-8 h-8 bg-gradient-primary-reverse rounded-lg flex items-center justify-center">
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="flex-shrink-0 inline-flex items-center gap-1 text-xs bg-gradient-primary-reverse text-white px-2 py-1 rounded-full">
            {matchIcon}
            {matchLevel}
          </span>
        </div>
