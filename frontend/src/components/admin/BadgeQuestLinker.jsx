...
export default function BadgeQuestLinker() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h2 className="text-2xl font-bold bg-gradient-to-r bg-gradient-primary-reverse bg-clip-text text-transparent mb-4">
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-6 py-3 bg-gradient-to-r bg-gradient-primary-reverse text-white rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 font-medium"
                >
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-gradient-to-r bg-gradient-primary-reverse text-white rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50 text-sm font-medium"
                  >
                  ...
                  >
                    <div className="flex items-start justify-between">
                      ...
                      <button
                        ...
                        disabled={loading}
                        className="ml-3 px-3 py-1 bg-gradient-to-r bg-gradient-primary-reverse text-white rounded-lg hover:opacity-90 transition-opacity text-sm font-medium disabled:opacity-50"
                      >
                        Add
                      </button>
                    </div>
