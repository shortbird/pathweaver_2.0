            ...
            <div className="bg-red-50 p-6 rounded-lg border border-red-200">
              ...
              <div className="space-y-2">
                ...
                <button
                  ...
                  className="mt-4 px-4 py-2 bg-gradient-primary text-white rounded hover:opacity-90"
                >
                  View Suggestions
                </button>
              </div>
      ...
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          ...
          <button
            ...
            disabled={loading}
            className="px-4 py-2 bg-gradient-primary text-white rounded hover:opacity-90 disabled:opacity-50"
          >
      ...
      <div className="space-y-6">
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <button
            ...
            disabled={loading}
            className="px-6 py-3 bg-gradient-primary text-white rounded hover:opacity-90 disabled:opacity-50"
          >
