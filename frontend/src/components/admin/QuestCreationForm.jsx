...
const QuestCreationForm = ({ onClose, onSuccess }) => {
  ...
  const SectionHeader = ({ title, description, required = false, children }) => (
    <div className="mb-6">
      ...
      <div className="w-full h-px bg-gradient-primary-reverse mb-6"></div>
    </div>
  )
          ...
          >
            {AIModalComponent && (
              <button
                ...
                className="flex items-center space-x-2 bg-gradient-primary-reverse text-white px-4 py-2 rounded-lg hover:opacity-90 transition-opacity text-sm font-medium"
              >
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-center pt-4">
              <button
                type="button"
                onClick={addTask}
                className="px-6 py-3 bg-gradient-primary-reverse text-white rounded-lg hover:opacity-90 transition-all shadow-md hover:shadow-lg"
              >
