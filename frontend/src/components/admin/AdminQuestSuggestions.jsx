                  ...
                  {idea.status === 'pending' && (
                    <div className="flex gap-2 ml-4">
                      <button
                        ...
                        className="px-4 py-2 bg-gradient-to-r bg-gradient-primary-reverse text-white rounded-lg hover:opacity-90 font-medium"
                      >
                        Create This Quest
                      </button>
                      <button
            ...
            <div className="mb-6">
              ...
              <div className="space-y-3">
                <button
                  ...
                  disabled={processing}
                  className="w-full px-4 py-3 bg-gradient-to-r bg-gradient-primary-reverse text-white rounded-lg hover:opacity-90 font-medium flex flex-col items-center gap-1"
                >
