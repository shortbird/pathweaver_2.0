    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl max-w-lg w-full max-h-[90vh] overflow-hidden flex flex-col shadow-xl">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          ...
          {/* Pillar and XP. Schools that hide the pillars get the XP field on
              its own, full width, rather than an empty half-grid. */}
          <div className={hidePillars ? '' : 'grid grid-cols-2 gap-4'}>
            {!hidePillars && (
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">
                  Pillar
