...
const DiplomaIntroduction = () => {
  ...
  const getPersonaContent = () => {
    switch (persona) {
      case 'parent':
        return {
          headline: "Your Learner's Optio Portfolio Diploma",
          subtitle: "Where Learning Is The Journey, Not The Destination",
          description: "Your learner receives their Optio Portfolio Diploma on day one - not as something to earn, but as a living record of their learning journey. They'll discover what they're capable of through real creation and exploration.",
          benefits: [
            "Your learner discovers their true capabilities through actual creation",
      ...
      default:
        return {
          ...
          description: "Learners receive their Optio Portfolio Diploma on enrollment day - a living document that grows with their journey. Learning isn't about reaching a destination, but about who they become through discovery and creation.",
          benefits: [
            "Learners explore at their own pace with joy, not pressure",
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="relative">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-[#ef597b]/20 to-[#6d469b]/20 rounded-full mb-4">
              ...
              <span className="text-[#6d469b] font-semibold">Every Learner Gets Their Diploma on Day One</span>
      ...
      <div className="bg-gradient-to-br from-[#ef597b]/5 to-[#6d469b]/5 rounded-2xl p-8">
        <div className="text-center mb-8">
          <h3 className="text-2xl font-bold text-[#003f5c] mb-4">
            Why This Matters for {persona === 'parent' ? 'Your Learner' : 'You'}
          </h3>
        </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-yellow-700 mb-4">
              {persona === 'parent' 
                ? "Your learner's diploma is theirs from day one. They'll fill it with real creations, discoveries, and growth - not to prove themselves to others, but to celebrate their journey of becoming."
