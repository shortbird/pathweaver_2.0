          ...
          <div className="flex justify-between items-center mb-4">
            ...
            {!showNewSourceForm && (
              <button
                ...
                className="px-4 py-2 bg-gradient-primary-reverse text-white rounded-lg hover:opacity-90 flex items-center gap-2"
              >
                <Plus size={20} />
                Add New Source
              </button>
                      ...
                      <label
                        ...
                        className={`px-4 py-2 rounded-lg cursor-pointer transition-colors flex items-center gap-2 ${
                          uploadingSource === source.id
                            ...
                            : 'bg-gradient-primary-reverse text-white hover:opacity-90'
                        }`}
                      >
                        <Upload size={18} />
