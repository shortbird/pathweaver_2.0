  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 right-4 z-[90] flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-r from-optio-purple to-optio-pink text-white shadow-lg hover:opacity-90 transition"
      >
      ...
      {open && (
        <div className="fixed inset-0 z-[91]" onClick={reset}>
          <div
            className="absolute bottom-20 right-4 w-80 bg-white rounded-2xl shadow-2xl border border-gray-100 p-4"
