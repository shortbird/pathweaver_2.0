...
const TaskCard = ({ item }) => {
  ...
  return (
    ...
    >
      ...
      <button
        className="ml-4 px-3 py-1.5 bg-gradient-primary text-white rounded-lg text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity flex-shrink-0"
