  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await api.post(`/api/admin/organizations/${orgId}/users/create-username`, {
        ...
        link_to_me: formData.link_to_me
      })
      ...
      setCreatedCredentials({
        ...
        linkedToParent: response.data.linked_to_parent === true
      })
    ...
    return (
      <div className="fixed top-0 left-0 right-0 bottom-0 w-full h-full bg-black/50 flex items-center justify-center z-50 p-4 overflow-y-auto">
        <div className="bg-white rounded-xl p-6 w-full max-w-md my-auto">
          ...
          {createdCredentials.linkedToParent && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4">
              <p className="text-sm text-green-800">
                Linked to your account. You can now follow {createdCredentials.studentName}'s progress from your parent view.
              </p>
            </div>
          )}
    ...
    <div className="fixed top-0 left-0 right-0 bottom-0 w-full h-full bg-black/50 flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-white rounded-xl p-6 w-full max-w-md my-auto">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label className="mb-4 flex items-start gap-3 p-3 border border-gray-200 rounded-lg cursor-pointer hover:bg-gray-50">
            <input
              type="checkbox"
              checked={formData.link_to_me}
              onChange={(e) => setFormData({ ...formData, link_to_me: e.target.checked })}
