  ...
  return (
    <>
      ...
      <div className="mb-6 p-6 bg-gradient-to-br from-[#ef597b]/8 to-[#6d469b]/8 border-2 border-optio-purple/20 rounded-xl shadow-sm">
        ...
        <div className="flex flex-wrap gap-2 pt-4 border-t border-optio-purple/15">
          {Object.entries(evidenceTypeCounts).map(([type, count]) => (
            <div
              key={type}
              className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-white/60 backdrop-blur-sm rounded-full border border-optio-purple/20"
            >
