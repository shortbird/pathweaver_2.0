...
const AccreditedDiplomaModal = ({ isOpen, onClose }) => {
  const header = (
    <div className="flex items-center gap-3">
      ...
      <div>
        <h2 className="text-2xl font-bold text-white">Accredited High School Diploma</h2>
        <p className="text-white/90 text-sm">How Optio creates official transcripts</p>
      </div>
    </div>
  );
  ...
  return (
    ...
    >
      ...
      <div className="space-y-8">
        {/* Overview */}
        <div className="bg-gradient-to-r from-optio-pink/10 to-optio-purple/10 rounded-xl p-6">
