        ...
        <div className="p-8">
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-lg bg-gradient-primary-reverse flex items-center justify-center">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-primary-reverse flex items-center justify-center">
            ...
            <div>
              ...
              <div className="bg-gray-50 rounded-xl p-6">
                ...
                <div className="flex justify-between items-center pt-4 border-t border-gray-300">
                  ...
                  <span className="text-xl font-bold bg-gradient-primary-reverse bg-clip-text text-transparent">
          ...
          <div className="flex justify-end mt-8 pt-6 border-t border-gray-200">
            <button
              onClick={onClose}
              className="px-6 py-3 rounded-lg bg-gradient-primary-reverse text-white hover:shadow-lg transition-shadow font-medium"
            >
              Got it!
            </button>
          </div>
