...
const SkillsRadarChart = ({ skillsXP }) => {
  ...
  const competencyInfo = {
    arts_creativity: {
      ...
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M20.71 4.63l-1.34-1.34c-.39-.39-1.02-.39-1.41 0L9 12.25 11.75 15l8.96-8.96c.39-.39.39-1.02 0-1.41zM2 20h2.42l8.96-8.96-2.42-2.42L2 17.58V20z" />
        </svg>
      ),
    ...
    stem_logic: {
      ...
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M9 2v6c0 .55.45 1 1 1h4c.55 0 1-.45 1-1V2h2c.55 0 1 .45 1 1v6c0 4.42-3.58 8-8 8s-8-3.58-8-8V3c0-.55.45-1 1-1h2zm1 4V4h4v2h-4zm-3 14c0 1.1.9 2 2 2h6c1.1 0 2-.9 2-2v-1H7v1z" />
        </svg>
      ),
