...
const SkillsRadarChart = ({ skillsXP }) => {
  ...
  const competencyInfo = {
    arts_creativity: {
      ...
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M9.26 2.75c-.17 0-.33.04-.48.1L7.17 3.5c-.47.19-.78.65-.78 1.15v.85c0 .28.1.54.27.75L8 8.25v10c0 .83.67 1.5 1.5 1.5h.5c.28 0 .5-.22.5-.5s-.22-.5-.5-.5H9.5c-.28 0-.5-.22-.5-.5v-10c0-.19-.07-.37-.19-.51l-1.31-1.5c-.06-.07-.1-.16-.1-.26v-.85c0-.17.1-.32.25-.39l1.61-.65c.05-.02.1-.03.15-.03.28 0 .5-.22.5-.5s-.23-.5-.5-.5zm6 0c-.28 0-.5.22-.5.5s.22.5.5.5c.05 0 .1.01.15.03l1.61.65c.15.07.25.22.25.39v.85c0 .1-.04.19-.1.26l-1.31 1.5c-.12.14-.19.32-.19.51v10c0 .28-.22.5-.5.5h-.5c-.28 0-.5.22-.5.5s.22.5.5.5h.5c.83 0 1.5-.67 1.5-1.5v-10l1.34-1.5c.17-.21.27-.47.27-.75v-.85c0-.5-.31-.96-.78-1.15l-1.61-.65c-.15-.06-.31-.1-.48-.1z" />
        </svg>
      ),
    ...
    stem_logic: {
      ...
      icon: (
        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          <path d="M9 2v5.5c0 .3.1.6.3.8L12 11l2.7-2.7c.2-.2.3-.5.3-.8V2H9zm6 16.5c0 .8-.7 1.5-1.5 1.5h-3c-.8 0-1.5-.7-1.5-1.5V17h6v1.5zM8.5 15L12 8.5 15.5 15H8.5z" />
        </svg>
      ),
