    ...
    <div className="space-y-4">
      ...
      {!suggestions && (
        <button
          ...
          disabled={loading}
          className="w-full bg-gradient-to-r bg-gradient-primary-reverse text-white py-3 px-4 rounded-lg font-medium hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center justify-center space-x-2"
        >
          {loading ? (
            <>
