    ...
    <div className="space-y-4">
      ...
      {!suggestions && (
        <button
          ...
          disabled={loading}
          className="w-full bg-gradient-to-r from-[#ef597b] to-[#6d469b] text-white py-3 px-4 rounded-lg font-medium hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center justify-center space-x-2"
        >
          {loading ? (
            <>
