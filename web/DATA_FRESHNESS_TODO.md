...
### Core Infrastructure
1. `web/src/App.jsx` - QueryClient configuration
2. `web/src/utils/queryKeys.js` - NEW: Query key factory
3. `web/src/hooks/api/` - NEW: API hooks directory

### Authentication
4. `web/src/contexts/AuthContext.jsx` - Migrate to React Query
5. `web/src/services/authService.js` - Update to invalidate caches

### Pages
6. `web/src/pages/DashboardPage.jsx` - Full React Query migration
7. `web/src/pages/QuestHubV3Improved.jsx` - Convert to useQuery
8. `web/src/pages/QuestDetailV3.jsx` - Add proper invalidation
9. `web/src/pages/FriendsPage.jsx` - Migrate to hooks
10. `web/src/pages/ProfilePage.jsx` - Add cache updates
