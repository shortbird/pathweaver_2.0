...
// The page reads every tab through hooks/api/useSisCommunity, so it needs a
// QueryClient. A fresh client per render keeps one test's cache out of the
// next one's, and retry:false makes a failed query fail the assertion rather
// than hang for three backoff rounds.
const render = (ui) => {
