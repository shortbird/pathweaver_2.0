...
const GroupChatWindow = ({ group, onBack }) => {
  ...
  // one from a notification could not tell whose class it was without leaving
  // the thread to look it up — that was the "before I can even respond" half of
  // the report. The list row already carries this; groupDetails refreshes it,
  // so prefer whichever has arrived.
  const childContext = React.useMemo(() => {
    const src = groupDetails?.for_students ? groupDetails : group
