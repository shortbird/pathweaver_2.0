...
1. web/src/components/parent/AddDependentModal.jsx
2. web/src/components/badges/BadgeInfoModal.jsx
3. web/src/components/admin/BulkEmailModal.jsx
4. web/src/components/admin/ChatLogsModal.jsx
5. web/src/components/advisor/TaskEditModal.jsx
6. web/src/components/calendar/EventDetailModal.jsx
7. web/src/components/connections/Modals/AddLearningPartnerModal.jsx
8. web/src/components/connections/Modals/AddObserverModal.jsx
9. web/src/components/connections/Modals/InviteParentModal.jsx
10. web/src/components/CreateQuestModal.jsx
11. web/src/components/demo/InfoModal.jsx
12. web/src/components/hub/QuestBadgeInfoModal.jsx
13. web/src/components/diploma/AccreditedDiplomaModal.jsx
14. web/src/components/diploma/evidence/EvidenceViewerModal.jsx
...
1. ❌ web/src/components/ReflectionModal.jsx
2. ❌ web/src/components/services/ServiceInquiryModal.jsx
3. ❌ web/src/components/admin/ServiceFormModal.jsx
4. ❌ web/src/components/learning-events/LearningEventDetailModal.jsx
5. ❌ web/src/components/parent/AddChildrenModal.jsx
6. ❌ web/src/components/quest/RestartQuestModal.jsx
7. ❌ web/src/components/parent/RequestStudentConnectionModal.jsx
8. ❌ web/src/components/advisor/AdvisorNotesModal.jsx

#### Complex Modals (11 files - Priority 2)
These require careful refactoring due to special features:

9. ❌ web/src/components/learning-events/LearningEventModal.jsx (file upload, complex state)
10. ❌ web/src/components/quest/TaskDetailModal.jsx (custom pillar colors)
11. ❌ web/src/components/tutor/OptioBotModal.jsx (chat interface, modes)
12. ❌ web/src/components/admin/AIQuestReviewModal.jsx (pagination, filters)
13. ❌ web/src/components/admin/QuestSelectionModal.jsx (modal transitions)
14. ❌ web/src/components/admin/UserDetailsModal.jsx (nested modals, tabs)
15. ❌ web/src/components/advisor/AddEvidenceModal.jsx (multi-step wizard)
16. ❌ web/src/components/advisor/CheckinHistoryModal.jsx (expandable lists)
17. ❌ web/src/components/advisor/StudentDetailModal.jsx (tabs, complex state)
18. ❌ web/src/components/quest/TaskCompletionModal.jsx (error boundary)
19. ❌ web/src/components/quest/TaskEvidenceModal.jsx (error boundary, refs)

#### Pages with Inline Modals (12 files - Priority 3)
These have modals embedded in page components:

20. ❌ web/src/pages/QuestDetail.jsx
21. ❌ web/src/pages/ParentDashboardPage.jsx
22. ❌ web/src/pages/DiplomaPage.jsx
23. ❌ web/src/components/navigation/Sidebar.jsx
24. ❌ web/src/components/admin/AdminConnections.jsx
25. ❌ web/src/components/admin/UnifiedQuestForm.jsx
26. ❌ web/src/components/quests/QuestPersonalizationWizard.jsx
27. ❌ web/src/pages/admin/OrganizationManagement.jsx
28. ❌ web/src/pages/admin/OrganizationDashboard.jsx
29. ❌ web/src/pages/admin/SubjectReviewPage.jsx
30. ❌ web/src/pages/TaskLibraryBrowser.jsx
31. ❌ web/src/components/evidence/MultiFormatEvidenceEditor.jsx
32. ❌ web/src/components/admin/crm/TemplateEditor.jsx
33. ❌ web/src/components/admin/QuestCreationForm.jsx
34. ❌ web/src/components/admin/CourseQuestForm.jsx
35. ❌ web/src/components/admin/BadgeQuestManager.jsx
36. ❌ web/src/components/admin/BulkQuestGenerator.jsx
37. ❌ web/src/components/admin/AdvisorTaskForm.jsx
38. ❌ web/src/pages/HomePage.jsx
39. ❌ web/src/components/SourcesManager.jsx
40. ❌ web/src/components/admin/FlaggedTasksPanel.jsx
41. ❌ web/src/components/admin/BadgeForm.jsx
...
- ✅ Button component exists at: web/src/components/Button.jsx
...
```bash
node web/scripts/refactor-modals.js
```
...
grep -r "bg-gradient-to-r from-optio-purple to-optio-pink" web/src --include="*.jsx"

# Find all hardcoded primary buttons
grep -r "bg-gradient-primary" web/src --include="*.jsx"
```
...
1. **Immediate** (1-2 hours):
   - Run `node web/scripts/refactor-modals.js`
