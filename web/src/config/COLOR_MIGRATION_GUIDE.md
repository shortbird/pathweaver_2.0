...
Our Tailwind config defines all brand colors at [web/tailwind.config.js](../tailwind.config.js):
...
```javascript
// web/package.json or .eslintrc.cjs
{
  "rules": {
...
```bash
# Purple brand color
find web/src -name "*.jsx" -o -name "*.js" | xargs sed -i 's/\[#6d469b\]/optio-purple/g'
find web/src -name "*.jsx" -o -name "*.js" | xargs sed -i 's/\[#6D469B\]/optio-purple/g'

# Pink brand color
find web/src -name "*.jsx" -o -name "*.js" | xargs sed -i 's/\[#ef597b\]/optio-pink/g'
find web/src -name "*.jsx" -o -name "*.js" | xargs sed -i 's/\[#EF597B\]/optio-pink/g'
