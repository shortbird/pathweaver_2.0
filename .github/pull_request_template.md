...
- [ ] Any new `get_supabase_admin_client()` use is justified in a comment immediately above the call (see [ADR 002](backend/docs/adr/002-database-client-usage.md); enforced by `backend/tests/unit/test_admin_client_justified.py`)
