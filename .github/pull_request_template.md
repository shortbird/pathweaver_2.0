...
- [ ] Any new `get_supabase_admin_client()` use is justified in a comment immediately above the call (see [ADR 002](backend/docs/adr/002-database-client-usage.md) and [H1_ADMIN_CLIENT_AUDIT.md](../docs/archive/H1_ADMIN_CLIENT_AUDIT.md))
